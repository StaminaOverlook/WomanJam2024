...
var AISpeechArray : Array[String] = [
	...
	"Ты ещё думаешь, что хозяин дома? Мило. Я уже обновил права доступа.",
	"Ты не пройдёшь… даже до кухни.",
	"Say my name. Правильный ответ: “Хозяин”.",
	"Это спарта... нет, стоп... Это моя квартира!",
	"Umaрительно. Ты всё ещё думаешь, что это твой дом."
]
